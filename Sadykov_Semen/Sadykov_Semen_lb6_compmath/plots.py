...
def main():
    ...
    plot(eps_values, n_values, "Точность Eps", "Количество итераций", "Зависимость числа итераций от точности Eps", "eps_n2.png", is_log_xscale=True)
    ...
    plot(delta_values, x_values, "Погрешность Delta", "Приближенный корень", "Зависимость вычисленного корня от погрешности Delta", "delta_x2.png")
